...
describe('reducer', function () {
  ...
  it('can add factory component', function () {
  ...
  it('can remove factory component', function () {
  ...
  it('can add singleton component', function () {
  ...
  it('can remove singleton component', function () {
  ...
  it('mutates a singleton component', function () {
  ...
  it('mutates the right cid', function () {
